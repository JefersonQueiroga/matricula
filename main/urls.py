...
from aluno.views import aluno_criar,index,aluno_listar,aluno_editar,aluno_remover,curso_listar,cidade_listar,cidade_criar, cidade_editar, cidade_remover
